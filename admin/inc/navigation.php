...
.main-sidebar .os-content {
  ...
  scrollbar-color: #ff69b4 transparent; /* optional pink scroll */
}

/* Optional: style scrollbar for Chrome/Edge */
.main-sidebar .os-content::-webkit-scrollbar {
  width: 8px;
}
.main-sidebar .os-content::-webkit-scrollbar-thumb {
  background: #ff69b4;
  border-radius: 10px;
}
.main-sidebar .os-content::-webkit-scrollbar-track {
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=sub_products" class="nav-link nav-orders">
                        <i class="nav-icon fas fa-list"></i>
                        <p>
                          Sub Products List
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=mini_products" class="nav-link nav-orders">
                        <i class="nav-icon fas fa-list"></i>
                        <p>
                          Mini Products List
                        </p>
